...
//
//  Created by Tommy Keaty on 12/26/17.
//  Copyright © 2017 Tommy Keaty. All rights reserved.
//
...
class LevelTransition: SKScene {
    ...
    func flipScene(){
        let block = SKAction.run {
            let myScene = GameScene.init(size: self.size)
